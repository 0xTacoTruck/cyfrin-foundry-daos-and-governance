...
import {MyGovernor} from "../../src/DaoGovernor.sol";
...
contract MyGovernorTest is Test {
    ...
    function setUp() public {
        token = new GovToken();
        token.mint(VOTER, 100e18); //Mint tokens so we can vote on things for testing and demonstration
    ...
    function testGovernanceUpdatesBox() public {
        ...
        bytes memory encodedFunctionCall = abi.encodeWithSignature("storeNewNumber(uint256)", valueToStore);
